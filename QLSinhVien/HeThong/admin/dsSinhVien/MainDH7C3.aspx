<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainDH7C3.aspx.cs" Inherits="QLSinhVien.HeThong.admin.dsSinhVien.MainDH7C3" %>
  ...
  <div class="khungChuaBang1">
            <div class="head1">
                Thêm mới,chỉnh sửa sinh viên lớp DH7C3
            </div>
            <div class="col-sm-12">
    ...
    <script type="text/javascript">
        ...
        // load sinh viên
        function loadData() {
            $.post(encodeURI(urlActionHandler), { "do": "loaddatalop3" }, function (data) {
                var htmlData = "";
                for (var i = 0; i < data.length; i++) {
                    htmlData +=
                        "<tr row_id=" + data[i].ID + ">"
