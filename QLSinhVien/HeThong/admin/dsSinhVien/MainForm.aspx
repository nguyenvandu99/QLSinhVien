<%@ Page Title="" Language="C#" MasterPageFile="~/Layouts/dsSinhVien.master" AutoEventWireup="true" CodeBehind="MainForm.aspx.cs" Inherits="QLSinhVien.HeThong.admin.dsSinhVien.MainForm" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cpldsSinhVien" runat="server">
    ...
    <script type="text/javascript">
        ...
        // load sinh viên
        function loadData() {
            $.post(encodeURI(urlActionHandler), { "do": "loaddatalop1" }, function (data) {
                var htmlData = "";
                for (var i = 0; i < data.length; i++) {
                    htmlData +=
                        "<tr row_id=" + data[i].ID + ">"
