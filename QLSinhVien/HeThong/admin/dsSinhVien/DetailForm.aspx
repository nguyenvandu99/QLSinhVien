...
<form autocomplete="off" onsubmit="event.preventDefault();" class="form-horizontal" id="frmHS" role="form">
    ...
    <div class="form-group">
        <label class="control-label col-sm-2">Họ và tên(*):<label class="validation-error hide" id="txtHoTenValidationError">Vui lòng nhập họ tên sinh viên.</label>
        </label>
        <div class="col-sm-10">
            <input name="txtTen" type="text" id="txtTen" class="form-control" value="<%=hs.TEN %>" />
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <div>
                <textarea rows="5" cols="100" name="txtQueQuan" id="txtQueQuan" class="form-control"  > <%=hs.QUEQUAN %> </textarea>
            </div>
        </div>
    </div>
    <div class="form-group">
