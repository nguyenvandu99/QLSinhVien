<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="MainForm.aspx.cs" Inherits="QLSinhVien.HeThong.admin.dsMonHoc.MainForm" %>
    ...
    <script>
        ...
        function RegisterMainEvent() {
            $("#btnAdd").click(function () {
                ...
                $("#jdialog").dialog({ title: "Thêm mới môn học", width: formWidth, height: formHeight }).dialog("open");
                return false;
            });
            //button search
        ...
        function EditItem(itemID) {
            ...
            $("#jdialog").dialog({ title: "Cập nhật thông tin môn học có mã ID = " + itemID, width: formWidth, height: formHeight }).dialog("open");
        }
